...
if ($mod == 'signup') {
    ...
    if ($db->get_results("SELECT * FROM tb_user WHERE email='$email'")){
        ...
        $db->query("INSERT INTO tb_user (kode_user, email, pass, user, tgl_lahir, jenis_kelamin, kota_asal, pekerjaan, hak_akses, created_at) VALUES ('$kode_user', '$email', '$pass1', '$user', '$tgl', '$jkel', '$kota', '$pekerjaan', '1', '$time')");
